...
PCout = zeros(3,Settings.ScanLength);
...
%         disp(ImageInd)
        ...
        [F(:,:,ImageInd), g(:,:,ImageInd), U(:,:,ImageInd), ~, XX(:,:,ImageInd), sigma(:,:,ImageInd), PCout(:,ImageInd)] = ...
            GetDefGradientTensor(Inds(ImageInd),Settings,Settings.Phase{ImageInd});%fitMetrics(ImageInd)
...
%         disp(ImageInd)
        ...
        [F(:,:,ImageInd), g(:,:,ImageInd), U(:,:,ImageInd), fitMetrics(:,:,ImageInd), XX(:,:,ImageInd), sigma(:,:,ImageInd), PCout(:,ImageInd)] = ...
