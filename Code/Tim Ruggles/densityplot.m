...
function [H,N] = densityplot(x,y,varargin)
...
N=N/(sum(sum(N))/sum(sum(N~=0))); % change to multiple of uniform distribution MUD)
...
c=colorbar;
c.Label.String = 'Multiples of Uniform Distribution (MUD)'
colormap jet
set(gca,'FontSize',16)
