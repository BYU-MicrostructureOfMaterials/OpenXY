...
%     Settings.roiyc = roiyc;
    ...
    [roixc,roiyc]= GetROIs(ScanImage,Settings.NumROIs,pixsize,...
    ...
    case 'Dynamic Simulated'
        ...
        if Settings.SinglePattern
            ...
            [F1,SSE1,XX] = CalcF(RefImage,ScanImage,gr,eye(3),ImageInd,...
                curMaterial,Settings.RefImageInd,PC,roixc,roiyc,...
        ...
        clear global rs cs Gs
        [F1,SSE1,XX] = CalcF(RefImage,ScanImage,gr,eye(3),ImageInd,...
            curMaterial,0,PC,roixc,roiyc,Settings.ROIFilter,ROISize,...
            standev,sampletilt,pixsize,elevang,calcMI,showPlot,method);
        ...
        for iq=1:5
            ...
            [F1,SSE1,XX,sigma] = CalcF(RefImage,ScanImage,gr,eye(3),...
                ImageInd,curMaterial,0,PC,roixc,roiyc,...
                Settings.ROIFilter,ROISize,standev,sampletilt,pixsize,...
                elevang,calcMI,showPlot,method);
        end
        %%%%%
...
%         disp(RefImagePath);
        ...
        [F1,SSE1,XX,sigma] = CalcF(RefImage,ScanImage,gr,eye(3),...
            ImageInd,curMaterial,RefImageInd,PC,roixc,roiyc,...
...
if DoLGrid
    ...
    clear global rs cs Gs
    [F.a SSE.a] = CalcF(ScanImage,LegAImage,gr,eye(3),ImageInd,...
    ...
    clear global rs cs Gs
    [F.c SSE.c] = CalcF(ScanImage,LegCImage,gr,eye(3),ImageInd,...
        curMaterial,ImageInd,PC,roixc,roiyc,Settings.ROIFilter,ROISize,...
        standev,sampletilt,pixsize,elevang,calcMI,showPlot,method);%note - sending in index of scan point for now - no PC correction!!!
