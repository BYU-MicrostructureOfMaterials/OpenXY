function genEBSDPatternHybridLineOverlay(g,params,F,lattice,alattice,blattice,clattice,axs,varargin)
...
%         keyboard
        ...
        if sum(abs(imag(xp)))>0
            ...
            masterx = [masterx x 0/0];
            mastery = [mastery yp 0/0];
            masterx = [masterx x 0/0];
            mastery = [mastery ym 0/0];

        else
            
            masterx = [masterx xm 0/0];
            mastery = [mastery y 0/0];
            masterx = [masterx xp 0/0];
            mastery = [mastery y 0/0];
