...
switch Settings.HROIMMethod
    ...
    case 'Dynamic Simulated'
        ...
        for i = 1:3
            ...
            clear global rs cs Gs
            [F,SSE] = CalcF(I1,I0,g,eye(3),ImageInd,...
    ...
    otherwise
        ...
        for i = 1:3
            ...
            clear global rs cs Gs
            [F SSE] = CalcF(I1,I0,g,F,ImageInd,Settings.Phase{ImageInd},...
                0,PC,Settings.roixc,Settings.roiyc,Settings.ROIFilter,...
                ROISize,standev,sampleTilt,pixelSize,cameraElevation,...
                calcMI,0,method);
        end
