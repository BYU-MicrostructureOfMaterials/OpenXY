function alpha_data = DislocationDensityCalculate(Settings,MaxMisorientation,VaryStepSizeI)
...
Allg(Settings.Inds,:) = NewAngles;%Why is this being reassigned right after assignment?
Inds = Settings.Inds;
    ...
    if ~strcmp(Settings.ScanType,'L')
        ...
        if Settings.DoParallel > 1
            ...
            try
                ...
                if ~ppool
                    matlabpool('local',NumberOfCores);%#ok
                end
            end
