...
function [AllFa,AllSSEa,AllFc,AllSSEc, misanglea, misanglec] = DDCalc(RefInd,RefG,lattice,ImageFilter,Settings)
    ...
    if (isempty(image_a)) || (isempty(image_b)) ||  (isempty(image_c)) || ...
        ...
        if r > 1 %Not Line Scan
            ...
            if RefIndA2 == 0
                    [AllFa,AllSSEa] = CalcF(image_b,image_a,g_b,eye(3),cnt,Settings, RefIndA);
            else
                [AllFa1,AllSSEa1] = CalcF(image_b,image_a ,g_b,eye(3),cnt,Settings,RefIndA );
                [AllFa2,AllSSEa2] = CalcF(image_b,image_a2,g_b,eye(3),cnt,Settings,RefIndA2);
        ...
        clear global rs cs Gs
        if RefIndC2 == 0
            [AllFc,AllSSEc] = CalcF(image_b,image_c ,g_b,eye(3),cnt,Settings,RefIndC);
        else
            [AllFc1,AllSSEc1] = CalcF(image_b,image_c ,g_b,eye(3),cnt,Settings,RefIndC );
            [AllFc2,AllSSEc2] = CalcF(image_b,image_c2,g_b,eye(3),cnt,Settings,RefIndC2);
